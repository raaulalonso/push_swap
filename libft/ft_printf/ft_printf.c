...
/*   Updated: 2023/11/01 16:44:40 by raalonso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (print[i + 1] == 's')
		*count += (ft_putstr(va_arg(*param, char *), 1) - 2);
	else if (print[i + 1] == 'c')
		*count += (ft_putchar(va_arg(*param, int), 1) - 2);
	else if ((print[i + 1] == 'i') || (print[i + 1] == 'd'))
		*count += (ft_putnbr(va_arg(*param, int), 1) - 2);
	else if (print[i + 1] == 'u')
